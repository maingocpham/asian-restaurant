...
// Define hardcoded credentials for testing (optional, can be removed in production)
$admin_username = "adminuser"; 
$admin_password = "adminpassword"; // Password should be hashed in real production use
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Query the database to check if the admin credentials are correct
    ...
    if ($result->num_rows > 0) {
        ...
        if ($password == $user['password']) {
            ...
            // Redirect to the admin dashboard (you can change this to the appropriate page)
...
<head>
    ...
    <title>Admin Login - Asian Asian</title>
    <style>
        /* Keep the same style as in your previous code */
        body {
