...
function displayTable($conn, $tableName, $searchData) {
    ...
    if ($result && $result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            // Check if it's an 'orders' table or 'reservation' table
            if ($tableName == 'orders') {
            ...
            echo "<td><form action='staff_delete_entry.php' method='post'>
...
<nav>
    ...
    <a href="staff_reservation.html">Reservations</a>
