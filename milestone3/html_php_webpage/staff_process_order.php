...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($stmt = $conn->prepare($sql)) {
        ...
        if ($stmt->execute()) {
            ...
            header('Location: order_confirm.html'); // Redirect to confirmation page
            exit();
        } else {
    ...
    // Redirect to the staff order page if the form wasn't submitted
    header('Location: staff_order.html');
    exit();
}
?>
...
<nav>
    ...
    <a href="staff_order.html">Make Order</a>
    <a href="staff_reservation.php">Reservations</a>
